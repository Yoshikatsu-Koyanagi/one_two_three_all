...
export default { 
  ...
  methods: {
    draw_1_btn(num_color){
      ...
      this.context.fillText(1, this.nbw*0.5, this.nbh*0.8,this.nbw);
    },
  },
  mounted() {
    this.nbw = this.width;
    ...
    canvas.addEventListener('touchstart', () => { 
        let gradient = this.context.createLinearGradient(this.nbw*0.5,0,this.nbw*0.5,this.nbh);
